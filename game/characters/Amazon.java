...
public class Amazon extends Character {
    ...
    public Amazon(String name) {
        super(name, 70, 12, 70, "Elf",10,10,10);
    }
    ...
    public void setStats()
    {
        ...
        setPower((int) (getPower()*(0.12*getAgility())));
    ...
    public void pickItem(Item item) {
        if(item.getType() == ItemType.Bow && this.weapon == null)
        {
            setWeapon(item);
        ...
        else if(item.getType() == ItemType.Hammer && this.weapon != null)
        {
