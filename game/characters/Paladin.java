...
public class Paladin extends Character {
    ...
    public Paladin(String name) {
        super(name, 100, 10, 100, "Human",10,10,10);
    }
    ...
    {
        if(item.getType() == ItemType.Hammer && this.rightHand == null)
        {
            setRightHand(item);
        ...
        else if(item.getType() == ItemType.Hammer && this.rightHand != null)
        {
        ...
        else if(item.getType() == ItemType.Shield && this.leftHand == null)
        {
            setLeftHand(item);
            setStamina(getStamina() + item.getStamina());
            setAgility(getAgility() + item.getAgility());
