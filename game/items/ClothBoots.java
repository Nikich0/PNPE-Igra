...
public class ClothBoots extends Item implements IUsableByNecromancer, IUsableByWitch{

    private String[] _prefix = new String[] {"Basic", "Rare", "Epic", "Legendary"};
    public ClothBoots(String name) {
        super(ItemType.ClothBoots, name, 10, 5, 18,0);
